        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <aside class="col-sm-3">
                    ...
                    <p class="alert alert-success">Free Delivery within Nyeri CBD. </p>
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside"><img src="{{ asset('frontend/images/icons/pay_mpesa.png') }}" alt="mpesa logo"></aside>
                        <div class="text-wrap small text-muted">
                            Pay from the palm of your hand using mpesa
                        </div>
                    </figure>
{{--                    <figure class="itemside mb-3">--}}
